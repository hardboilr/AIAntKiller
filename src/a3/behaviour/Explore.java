...
public class Explore {
    ...
    public EAction getAction() {
        ...
        System.out.println("thisLocation: " + thisLocation.getX() + "," + thisLocation.getY());
        ...
        if (possibleLocations.size() > 0) {
            int movementDirection = getMovementDirection(thisLocation, possibleLocations.first());
            System.out.println("chosenLocation: " + possibleLocations.first());

            int chosenDirection = possibleLocations.first().getDirection();
            System.out.println("chosenDirection: " + movementDirection);
